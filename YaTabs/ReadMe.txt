========================================================================
    ACTIVE TEMPLATE LIBRARY : YaTabs Project Overview
========================================================================

AppWizard has created this YaTabs project for you to use as the starting point for
...
YaTabs.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (YaTabs.h)
        GUID definitions                                (YaTabs_i.c)
        A type library                                  (YaTabs.tlb)
        Marshaling code                                 (YaTabs_p.c and dlldata.c)

YaTabs.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in YaTabs.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named YaTabs.pch and a precompiled types file named StdAfx.obj.
...
YaTabsps.vcxproj
	...
	dlldata.c, YaTabs_i.c and YaTabs_p.c which are required
	to build the proxy/stub DLL.

YaTabsps.vcxproj.filters
